...
<div class="container">
    <div class="text-right">
        <a class="btn btn-default" href="<?php echo Smpe_Url::http('Support', 'Help', 'Add')?>" role="button">Add</a>
    </div>
    ...
    <div class="text-center">
        <?php echo Smpe_Pagination::full(Smpe_Url::http('Support', 'Help', 'Browse'), $this->data['HelpCount'], $this->pagination['PageSize'], $_GET)?>
    </div>
</div>
<script>
