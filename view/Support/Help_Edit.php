...
?>
<link href="<?php echo Smpe_Url::pub('/src/showdown/example/showdown-gui.css')?>" rel="stylesheet">
<div>
...
<script src="<?php echo Smpe_Url::pub('/src/showdown/example/showdown-gui.js')?>"></script>
                ...
                $(form).ajaxSubmit({
                    ...
                    success: function(data, textStatus, jqXHR){
                        ...
                        if(data.data <= 0) {
                            ...
                            window.location = "<?php echo Smpe_Url::http('Support', 'Help', 'Detail', $this->data['Help']['HelpID'])?>"
                        }
                    },
